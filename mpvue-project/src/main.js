...
export default {
  ...
  config: {
    ...
    pages: ['^pages/index/main', 'pages/details/main', 'pages/publish/main', 'pages/friend/main', 'pages/mine/main', 'pages/feedback/main', 'pages/joinList/main', 'pages/sendList/main'],
    window: {
